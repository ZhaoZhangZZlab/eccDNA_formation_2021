...
#	TE=TE.loc[(TE["RefStart"]<=fl) | (TE["RefEnd"]>=TE["RefLen"]-fl)].sort_values(["Readname","ReadStart"])
	print(TE.drop_duplicates(["Readname"],keep="first").shape)
	Genome=Genome.loc[(Genome["ReadStart"]>=fl) | (Genome["ReadEnd"]<=Genome["ReadLen"]-fl)]
	print(Genome.drop_duplicates(["Readname"],keep="first").shape)
	...
	o=combined.loc[combined["overlap"]==True].sort_values(["Readname","ReadStart_ref","ReadEnd_ref"])
	o=o.loc[~o["Readname"].isin(list(f["Readname"]))]
#	print(combined.shape)
#	print(o.shape)
#	print(o[0:30])
#	print(o.drop_duplicates(["Readname"],keep="first").shape)
#	print()
...
def get_insertions(filteredFile):
	...
	#print(f1.drop_duplicates(["Readname"],keep="first").shape)
	...
	for i in list(set(f2["Readname"]))[0:5]:
