...
samtools index $name"-TE_full.fa.bam";
samtools view -b -F 4 $name"-TE_full.fa.bam" |samtools fasta > $name"-TE_full.fa.bam.mapped.fasta"
grep ">" $name"-TE_full.fa.bam.mapped.fasta" |wc -l; 
done
done
